...
public class TouchPanelManager : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        //InputUpdater.Instance.SetBool(Area, true);
        UDPClient.instance.SendInputState(0, Area, true);
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        {
            //InputUpdater.Instance.SetBool(Area, false);
            UDPClient.instance.SendInputState(0, Area, false);
            touchDidChange?.Invoke();
        }
    }
    enum TouchArea
